...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="tampil/siswa/view.php">Table Calon Siswa</a>
            <a class="collapse-item" href="tampil/orang tua/view.php">Table Orang Tua</a>
            <a class="collapse-item" href="tampil/kelas/view.php">Table Kelas</a>
            <a class="collapse-item" href="tampil/ruangan/view.php">Table Ruangan</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="verifikasi/view.php" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
          <i class="fa-solid fa-people-roof"></i>
          <span>Verification</span>
        </a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="tampil/verifikasi/view.php">Siswa</a>
          </div>
        </div>
      </li>
      <!-- Divider -->
